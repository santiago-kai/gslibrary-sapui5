sap.ui.define([
	...
	var ListController = Controller.extend("sap.ui.demo.walkthrough.controller.UsersManage", {

		onInit : function (evt) {
			// set explored app's demo model on this sample
			var oModel = new JSONModel(jQuery.sap.getModulePath("sap.ui.demo.walkthrough.json", "/UserList.json"));
		...
		onSelectionChange : function (oEvt) {
			...
			var oEditBtn = this.byId("edit");
			var oDeleteBtn = this.byId("delete");
