sap.ui.define([
	...
	var PageController = Controller.extend("sap.ui.demo.walkthrough.controller.BooksBrowse", {
		onInit: function () {
...
/********************** Filter selection bar *************************/
		...
		getTableItems : function () {
			return this.getView().byId("idBooksTable").getBinding("items");
		},
...
/********************** Filter search bar *************************/
		onSearch : function (oEvt) {
			...
			// update list binding
			var list = this.byId("idBooksTable");
